...
--Вывести эту полученную таблицу
SELECT * FROM book;
--Либо с default, т.к. book_id - AUTO_INCREMENT (самозаполняющийся)
...
insert into book values (default, 'Братья Карамазовы', 'Достоевский Ф.М.', 799.01, 2);
SELECT * FROM book;
--
Affected rows: 1
Affected rows: 1
